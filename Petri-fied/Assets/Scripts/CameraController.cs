...
public class CameraController : MonoBehaviour
{
  ...
  // Gameobjects
  public Text verticalAngleLabel;
  ...
  void Update()
  {
    ...
    if (verticalAngleLabel)
    {
      verticalAngleLabel.text = Math.Round(GetCameraInclination()).ToString() + "°";
    }
  ...
  {
    return (curVerticalRotation * 180 / Mathf.PI) - 90; // angle in eularian degrees
  }
}
